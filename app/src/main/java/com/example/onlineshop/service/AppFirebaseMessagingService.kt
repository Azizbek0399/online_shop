    ...
    fun showMessage(title: String, body: String, id: Long = System.currentTimeMillis()){
        ...
        val builder =
            NotificationCompat.Builder(this, channelId)
                ...
                .setSmallIcon(R.drawable.ic__092564_profile_about_mobile_ui_user_icon)
                .setLargeIcon(BitmapFactory.decodeResource(applicationContext.resources, R.drawable.ic__092564_profile_about_mobile_ui_user_icon))
