...
import com.example.onlineshop.screen.productdetail.ProductDetailActivity
import com.example.onlineshop.utils.Constants
import kotlinx.android.synthetic.main.product_item_layout.view.*


class ProductAdapter(private var items:List<ProductModel>):RecyclerView.Adapter<ProductAdapter.ItemHolder>() {
